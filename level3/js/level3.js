...
let wall = {
    wallcells: [{ x: 210, y: 0 }, { x: 210, y: 14 }, { x: 210, y: 28 }, { x: 210, y: 42 }, { x: 210, y: 56 }, { x: 210, y: 70 }, { x: 210, y: 84 }, { x: 210, y: 98 }, { x: 224, y: 98 }, { x: 238, y: 98 }, { x: 252, y: 98 }, { x: 266, y: 98 }, { x: 280, y: 98 }, { x: 294, y: 98 }, { x: 308, y: 98 }, { x: 308, y: 84 }, { x: 308, y: 70 }, { x: 196, y: 98 }, { x: 182, y: 98 }, { x: 168, y: 98 }, { x: 154, y: 98 },
    { x: 0, y: 210 }, { y: 210, x: 14 }, { y: 210, x: 28 }, { y: 210, x: 42 }, { y: 210, x: 56 }, { y: 210, x: 70 }, { y: 210, x: 84 }, { y: 210, x: 98 },
    { x: 406, y: 210 }, { x: 392, y: 210 }, { x: 378, y: 210 }, { x: 364, y: 210 }, { x: 350, y: 210 }, { x: 336, y: 210 }, { x: 322, y: 210 }, { x: 308, y: 210 }, { x: 308, y: 224 }, { x: 308, y: 238 }, { x: 308, y: 252 }, { x: 308, y: 266 }, { x: 308, y: 280 }, { x: 308, y: 294 }, { x: 308, y: 308 }, { x: 308, y: 322 },
    { y: 406, x: 210 }, { y: 392, x: 210 }, { y: 378, x: 210 }, { y: 364, x: 210 }, { y: 350, x: 210 }, { y: 336, x: 210 }, { y: 322, x: 210 }, { y: 308, x: 210 }, { y: 336, x: 196 }, { y: 336, x: 182 }, { y: 336, x: 168 }, { y: 336, x: 154 }, { y: 336, x: 140 }, { y: 336, x: 126 }
    ]
}
...
if (keys.includes("move3")) {
    let alldata = JSON.parse(localStorage.getItem("move3"))
...
document.querySelector('.pause').addEventListener('click', () => {
    ...
    localStorage.setItem('move3', JSON.stringify(data));
...
document.querySelector('.resume').addEventListener('click', () => {
    if (!isMoving) {
        if (keys.includes('move3')) {
            let data = JSON.parse(localStorage.getItem('move3'));
...
const interval = setInterval(() => {
    ...
    time.innerHTML = "Time : " + timeInSec;
    if (snake.die || timeInSec <= 0) {
        gameOver();
